package uk.ac.city.aczg894.demo.config;
...
import uk.ac.city.aczg894.demo.services.WebsiteUserDetails;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
     ...
     */
    private WebsiteUserDetails websiteUserDetails;

    /**
     * Constructor based dependency injection of custom user details service.
     *
     * @param websiteUserDetails
     */
    @Autowired
    public SecurityConfig(WebsiteUserDetails websiteUserDetails){
        this.websiteUserDetails = websiteUserDetails;
    }
    ...
    /**
     * Only provide access to the profile pages to logged in users.
     *
     * @param http
     * @throws Exception
     */
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(websiteUserDetails);
