...
import uk.ac.city.aczg894.demo.services.ProfileService;
...
public class ProfileController {
     ...
     * to each of the domain objects (Website, LoginHistory (as a list)
     *
     */
    ...
    public ModelAndView showProfile(){
        ...
        return new ModelAndView("userProfile", "collatedUser", user);
    }
}
